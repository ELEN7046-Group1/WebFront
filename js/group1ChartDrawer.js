            ...
            d3.json(apiCall, function (error, data) {
                ...
                //if (data[key].province == "Western Cape") {
                    d3.select("#mainGroup")
                        ...
                        .attr("class", "province")
                        .style("fill", function (d) {
                            return scale(westernCape.count);
                        })
                ...
                //if (data[key].province == "KwaZulu-Natal") {
                    d3.select("#mainGroup")
                        ...
                        .attr("class", "province")
                        .style("fill", function (d) {
                            return scale(kwazuluNatal.count);
                        })
                ...
                //if (data[key].province == "Northern Cape") {
                    ...
                    d3.select("#mainGroup")
                        ...
                        .style("fill", function (d) {
                            return scale(northernCape.count);
                        })
                        .attr("class", "province")
                ...
                //if (data[key].province == "Eastern Cape") {
                    d3.select("#mainGroup")
                        ...
                        .style("fill", function (d) {
                            return scale(easternCape.count);
                        })
                        .attr("class", "province")
