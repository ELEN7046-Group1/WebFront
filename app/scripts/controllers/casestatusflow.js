    ...
    d3.json('http://104.197.190.158/elen7046/cases/sankey/1998-5-1/2016-5-1', function (error, data) {
      ...
      if (error) {
        ...
        var chart = sankeyChart()
          ...
          .width(1300)
          .height(650)
          .nodes(function(d) { return d.nodes.map(function(n) { return { name: n.name, node: n.node }; }); })
          .links(function(d) { return d.links.map(function(l) { return { source: l.source, target: l.target, value: l.value }; }); });
