...
function barChart() {
  var margin = { top: 20, right: 20, bottom: 20, left: 20 },
      ...
      barColor = "#FF0000",
      barTitleText = function(d) { return d[0] + ' : ' + d[1]; };
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var smallestDimension = d3.min([width, height], function (d) { return d; });
      ...
      groups.append('rect')
        ...
        .attr("y", function (d) { return margin.top + yScale(d[1]); })
        .attr("fill", barColor);
        //.append("title")
        //.text(function(d) { return barTitleText.call(data, d); });
