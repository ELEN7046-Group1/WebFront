...
(function (window) {
  ...
  var Chart = function (elemId, width, height, title, dataSet) {
  ...
  var CasesPerDayBarChart = function (elemId, width, height, title, dataSet) {
    ...
    function _draw() {
      ...
      var yAxis = d3.svg.axis().scale(yAxisScale).orient("left").tickSize(fontSize / 2);
  ...
  var ClaimsPerProvince = function (elemId, width, height) {
    Chart.call(this, elemId, width, height, null);
  ...
  group1ChartDrawer.ClaimsPerProvince = function (elemId, width, height) {
    return new ClaimsPerProvince(elemId, width, height);
  };
